...
@endphp
            <div class="flex flex-wrap items-center gap-2.5">
                ...
                <a href="{{ route('certificates.preview', $certificate) }}" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold shadow-sm transition">
